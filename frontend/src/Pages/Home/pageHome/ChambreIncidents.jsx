...
const incidentIcons = {
  ...
  AirConditioningAndHeating: <Air sx={{ fontSize: 30, color: "rgb(42, 219, 107)" }} />,
...
let incidentColor='neutral'

if(incident.status === "InProgress"){
let incidentColor = "neutral";
} else if(incident.status === "Resolved"){
  let incidentColor = "success";
}else if(incident.status === "Pending"){  
  let incidentColor = "danger";
}




export default function ChambreIncidents({ incident }) {
