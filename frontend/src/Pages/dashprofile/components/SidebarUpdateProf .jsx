...
import { BarChartOutlined, Domain, Engineering, Group, Message, SettingsSuggest } from "@mui/icons-material";
    ...
    <>
      ...
      <Sheet
              ...
              <Toggler
                renderToggle={({ open, setOpen }) => (
                  <ListItemButton onClick={() => setOpen(!open)}>
                    <GroupRoundedIcon color="warning" />
                    <ListItemContent>
        ...
        <Box sx={{ display: "flex", gap: 1, alignItems: "center" }}>
          ...
          <Typography level="title-sm">{adminProfile.firstName} {adminProfile.lastName}.</Typography>
