...
import { Autocomplete, CardContent, CardMedia, TextField } from "@mui/material";
...
export default function Room(chambre) {
  ...
  console.log(RoomData.residents)
  ...
  const [roomNumber, seeRoomNumber] = React.useState(RoomData.roomNumber);
  const [price, setPrice] = React.useState(RoomData.price);
  const [size, setSize] = React.useState(RoomData.roomSize);
  ...
  return (
    <Box sx={{ flex: 1, width: "100%" }}>
      <Stack
        ...
        <Card>
          <Box sx={{ mb: 1 }}>
            <Typography level="h6">Update Room</Typography>
          </Box>
          <Divider />
              ...
              <Stack direction="row" spacing={1}>
                <FormControl sx={{ flexGrow: 1, width: "100px" }}>
                  ...
                  <Input
                    ...
                    sx={{ width: "90px" }}
                    value={roomNumber}
                    onChange={(e) => seeRoomNumber(e.target.value)}
                    placeholder={RoomData.number}
                    size="sm"
                  />
                </FormControl>
          ...
          <Box>
            <Tabs
              ...
              <Box
                ...
                <TabPanel value={1} disabled></TabPanel>{" "}
              </Box>
            </Tabs>
          </Box>
        </Card>
