...
export default function ModalChambreIncidents({ open, onClose, incidents }) {
            ...
            <ul>
              {ins.map((incident) => (
                <li key={incident.incidentid} style={{ marginBottom: "10px" }}>
                  ...
                  <div>
                    <strong>technicien name :</strong> {incident.firstNameTechnicien} {incident.lastNameTechnicien}
                  </div>
