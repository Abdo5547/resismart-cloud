...
import ModalAddChambre from "../ModalAddChambre";
...
export default function OrderTable() {
  ...
  const [isChambreIncidentModalOpen, setIsChambreIncidentModalOpen] =
    React.useState(false);
  const [chambreIncidents, setChambreIncidents] = React.useState([{}]);
  const [isChambreResidentModalOpen, setIsChambreResidentModalOpen] =
    React.useState(false);
    ...
    <React.Fragment>
      ...
      <Box
        ...
        <FormControl sx={{ flex: 1 }} size="sm">
          <FormLabel>Search for Room</FormLabel>
          <Input
            size="sm"
            placeholder="Search"
            startDecorator={<SearchIcon />}
